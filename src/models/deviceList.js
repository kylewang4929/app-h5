...
export default {
  ...
  state: {
    data: [
      { name: '加热棒', isShare: true, netStatus: 2, onlineStatus: false, mac: 'virtual:site', did: 'ZJNNvXFM2zutcVUj5ipPCC', productKey: 'c6adaa249cf84d0ab96db5daa38622b0', remark: '{ "echo": true }' },
